<html>
	...
	<body>
		...
		if(isset($_SESSION["kullanici_ad"]) && isset($_SESSION["yetki"])){
			...
			<a href="adminpanel/yeni.php"><button type="button" class="btn btn-success btn-sm">Üye Ol</button></a>	';
		}
		?>
			...
			<div style="margin-top:20px" class="content">
				<div class="col-md-9 haberler">
					<?php
					$sql = "select * from haberler order by id desc limit 8";
					...
					?>
						...
						<div class="col-md-6">
							<img src="upload/<?php echo $rs->resim?>">
							<div style="margin-top:0px" class="alert alert-secondary" role="alert"><h5><?php echo $rs->baslik?></h5></div>
							<div style="margin-top:0px" class="alert alert-success" role="alert"><p><?php echo  substr($rs->aciklama,0,200)?>...</div>
								<div style="margin-top:0px" class="alert alert-warning" role="alert"><a href="detay.php?id=<?php echo $rs->id?>">Devamını oku</a></div>
							</p>
						</div>
			...
			<div style="border:solid" class="footer col-md-12">
				<?php
					include "footer.php";
				?>
			</div>
