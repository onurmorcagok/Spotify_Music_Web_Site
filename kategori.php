		...
		?>
			...
			<div class="content">
				<div class="col-md-9 haberler">
					<?php
					$sql = "select * from haberler where kategori_id=".$_GET["id"];
					...
					?>
						...
						<div class="col-md-5">
							...
							<div class="alert alert-success" role="alert"><p><?php echo  substr($rs->aciklama,0,200)?>...</div>
							<div class="alert alert-warning" role="alert"><a href="detay.php?id=<?php echo $rs->id?>">Devamını oku</a></div>
							</p>
						</div>
