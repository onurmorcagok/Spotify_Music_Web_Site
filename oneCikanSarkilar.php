			...
			<div class="header col-md-12">
				...
				<div style="margin-top:5px" class="minislider col-md-3">
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/gidengider.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/gidengider.mp3" type="audio/mpeg">
					...
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/acanim.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/acanim.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
					...
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/nefarkeder.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/nefarkeder.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
					...
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/prens-prenses.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/prens-prenses.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
				...
				<div style="margin-top:5px" class="minislider col-md-3">
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/askdedigin.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/askdedigin.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
					...
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/kedigibi.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/kedigibi.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
					...
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/yaparim.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/yaparımbilirsin.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
					...
					<div id="minisliderExampleControls" class="minislider slide" data-ride="left">
						  <div class="carousel-inner">
							<div class="carousel-item active">
							  <img src="img/vazgecmem.jpg" class="d-block w-100" alt="...">
							  <audio style="width:220px" controls>
						<source src="music/vazgecmem.mp3" type="audio/mpeg">
						Tarayıcınız audio(ses) ögesi desteklemiyor.
						</audio>
							</div>
						  </div>
