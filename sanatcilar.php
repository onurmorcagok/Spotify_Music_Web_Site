			...
			<div style="margin-top:20px" class="content">
				<div class="col-md-9 haberler">
					...
					?>
						...
						<div class="col-md-6">
							<div style="widtg:100%" class="alert alert-secondary" role="alert"><img src="img/<?php echo $rs->sanatciResmi?>"></div>
							<div class="alert alert-warning" role="alert"><a href="sanatciDetay.php?id=<?php echo $rs->sanatci_id?>"><?php echo $rs->sanatciAdi?></a></div>
							</p>
						</div>
